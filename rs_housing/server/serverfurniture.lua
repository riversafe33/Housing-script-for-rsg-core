...
AddEventHandler('rs_furniture:server:useitem', function(itemname)
    ...
    if not furnidata then
        TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
            Locales['HOUSING_NOTI'], Locales['FURNITURE_NOT_FOUND'],
            "menu_textures", "cross", 3000, "COLOR_RED")
        return
    end
...
AddEventHandler('rs_furniture:server:buy', function(propname, furnitem, furniname, cost, px, py, pz, ph)
    ...
    IsAuthorized(src, propname, function(auth)
        if not auth then
            TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                Locales['HOUSING_NOTI'], Locales['FURNITURE_NO_ACCESS'],
                "menu_textures", "cross", 3000, "COLOR_RED")
            return
        end
        ...
        GetFurniture(propname, function(furniture)
            if #furniture >= Config.furniturelimit then
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'], Locales['FURNITURE_LIMIT_REACHED'],
                    "menu_textures", "cross", 3000, "COLOR_RED")
                return
            end
            ...
            if Player.Functions.GetMoney('cash') < cost then
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'], Locales['FURNITURE_NOT_ENOUGH_MONEY'],
                    "menu_textures", "cross", 3000, "COLOR_RED")
                return
            end
            ...
            SaveFurniture(propname, furniture, function(ok)
                if not ok then
                    ...
                    TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                        Locales['HOUSING_NOTI'], Locales['FURNITURE_SAVE_ERROR'],
                        "menu_textures", "cross", 3000, "COLOR_RED")
                    return
                end
                ...
                TriggerClientEvent('rs_furniture:client:receive', src, propname, furniture)
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'], Locales['FURNITURE_PLACED'],
    ...
    IsAuthorized(src, propname, function(auth)
        ...
        GetFurniture(propname, function(furniture)
            ...
            if not exports['rsg-inventory']:HasItem(src, itemname, 1) then
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'], Locales['FURNITURE_NO_ITEM'],
                    "menu_textures", "cross", 3000, "COLOR_RED")
                return
            end
            ...
            if not exports['rsg-inventory']:RemoveItem(src, itemname, 1, nil, 'rs_furniture:place') then
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'], Locales['FURNITURE_REMOVE_ITEM_ERROR'],
                    "menu_textures", "cross", 3000, "COLOR_RED")
                return
            end
        ...
        GetFurniture(propname, function(furniture)
            ...
            SaveFurniture(propname, furniture, function(ok)
                ...
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    ...
                    Locales['FURNITURE_SOLD'] .. ' ' .. foundEntry.name .. ' ' .. Locales['FOR'] .. ' ' .. sellPrice .. '$',
                    "generic_textures", "tick", 3000, "COLOR_GREEN")
            end)
        end)
    end)
            ...
            SaveFurniture(propname, furniture, function(ok)
                ...
                if Config.furnitureitems and foundEntry.item then
                    ...
                    if canAdd then
                        ...
                        TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                            Locales['HOUSING_NOTI'], Locales['FURNITURE_INVENTORY_FULL'],
                            "menu_textures", "cross", 3000, "COLOR_RED")
                    end
                end
                ...
                TriggerClientEvent('rs_housing:ShowAdvancedNotification', src,
                    Locales['HOUSING_NOTI'],
                    Locales['FURNITURE_REMOVED'] .. ' "' .. (foundEntry.name or '?') .. '"',
                    "generic_textures", "tick", 3000, "COLOR_GREEN")
            end)
        end)
    end)
